...
import LightTheme from "../components/navigation/light-themeLive";
                ...
                <div className={styles?.fans}>
                  <div className="p-3">
                    <div className={styles?.menu}>
                      ...
                      <div
                        className={`${styles?.border} d-flex align-items-center`}
                      >
                        All media type{" "}
                        <span className={styles?.pinkColor}>
                          <AiFillCaretDown />
                    ...
                    <div className={styles?.fans}>
                      ...
                      <div className={styles?.feeds}>
                        <div className="mt-3 p-3">
                          <div className="">15 March, 2023</div>
                        ...
                        <div className="mt-3 p-3">
                          <div className="">12 March, 2023</div>
                          <div className="d-flex align-items-center">
                            <div className={styles?.xText}>X</div>{" "}
                        ...
                        <div className="mt-3 p-3">
                          <div className="">03 March, 2023</div>
                          <div className="d-flex align-items-center">
                            <div>
                              <img
            ...
            <div className="col-lg-3 col-md-12 mt-4">
              <div className={styles?.fans}>
                ...
                <div className="row mt-3 align-items-center px-2">
                  ...
                  <div className="col-3">
                    <span className="">3648</span>
                  </div>
                  <div className="col-3">
                    <span className="">4th</span>
                  </div>
                </div>
                <div className="row mt-3 align-items-center px-2 mb-3">
                  ...
                  <div className="col-3">
                    <span className="">1456</span>
                  </div>
                  <div className="col-3">
                    <span className="">5th</span>
                  </div>
                </div>
                <div className={styles.bottomBorder}></div>
                <div className="mt-3">
