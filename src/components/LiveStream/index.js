  ...
  return (
    <div className={styles?.LiveMain}>
      <div className="row justify-content-center p-0 m-0">
        ...
        >
          {/* <video width="100%" height={width < 767 ? width < 576 ? 200 : 300 : videoHeight} autoplay src="/video/promo-video.mp4" onLoad={(e) => e.target.play()} muted style={{ objectFit: "cover", maxHeight: 650 }} /> */}
          <video
            width="100%"
            height={width < 992 ? width / 2.5 : videoHeight}
            autoplay
            src="/video/promo-video.mp4"
            onLoad={(e) => e.target.play()}
            muted
            controls
            style={{ objectFit: "cover", maxHeight: 650, minHeight: 200 }}
          />
          ...
          <div style={{ position: "relative" }}>
            ...
            >
              ...
              {chatOpen ? (
                ...
                <BsBoxArrowInLeft color="#9e9e9e" size={18} className="ms-1" />
              )}
            </div>
            ...
            <img
              ...
              alt=""
              className=""
              style={{ height: videoHeight / 4, width: "100%", maxHeight: 162 }}
            />
          </div>
          <div style={{ position: "relative" }}>
            <img
              ...
              >
                ...
                >
                  ...
                  <div className="d-flex align-items-center pb-1">
                    <TbCrown size={22} color={"#c56565"} />
                    <div>
                      <p className={styles.chatText}>broadwaystar88 : thanks</p>
                    </div>
                  </div>
                  <div className="d-flex align-items-center pb-1">
                    <TbCrown size={22} color={"#c56565"} />
                  ...
                  <div className="d-flex align-items-center pb-1">
                    <TbCrown size={22} color={"#c56565"} />
                    <div>
                      <p className={styles.chatText}>broadwaystar88 : hello</p>
                    </div>
                  </div>
                  <div className="d-flex align-items-center pb-1">
                    <TbCrown size={22} color={"#c56565"} />
      ...
      <div className="mt-5 px-4">
        ...
        <div className="row mt-3">
          <div className="col-lg-6">
            <p>
              Oranum.com services are only available for persons over the age of
              18, and they are provided for entertainment purposes only. We
          ...
          <div className="col-lg-6">
            <p>
              Discover the unique opportunity to video chat with live psychics,
              giving you that real in-person feeling! At Oranum, you can get in
              touch when you need it as our experts are available round the
              clock with 24/7 support. Welcome to the Spiritual community!
            </p>
          </div>
        </div>
      </div>
