...
const SideBar = ({ collapse, setCollapse }) => {
  ...
  return (
    <>
      {collapse ? (
        <div
          className={`${styles.iconView} col-sm-2 p-0`}
          style={{
            width: "3.333333%",
        ...
        <div
          className={`col-sm-3 col-md-2 col-lg-2 col-2 p-0 ${styles.topView}`}
          style={{
            height: width > 670 ? height - 80 : height,
            overflow: "hidden",
          }}
          ...
          >
            <div className={styles.sideHeader}>
              <div className="d-flex justify-content-between mt-3 mx-3 ">
                <img
                  src="/mul-vod-main--xcrave-xcavelogo@2x.png"
            ...
            <div className="d-flex justify-contant-center align-items-center mt-4 ms-3 pt-3">
              <MdOutlineHome size={25} color="#818181" />
